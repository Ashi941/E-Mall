...
class UserScope():
    USER_SCOPES = [("ADMIN", "Administrator"), ("MANAGER", "Manager"),
                   ("USER", "User"), ("OTHER", "Other"), ]   #list of tuples


# Create your models here.
class User(AbstractUser):    #this class extends the class AbstractUser
    #By extending the class "AbstractUser" we can add extra fields if we feel that the fields in the tables give by Django is not enough
